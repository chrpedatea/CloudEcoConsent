...
public class ConsentController {
    ...
    private final static String CLIENT_ID = "72c4d5d8-53f5-4b64-97ad-7765975b9203";
    private final static String CLIENT_SECRET = "6eF8Q~iVk4ULlPPFH5bwIwfRPkOWjn8Pw1zadcih";
    private final static String AUTHORITY = "https://login.microsoftonline.com/common";
    private final static String REDIRECT_URI = "https://ateacloudeconomics.azurewebsites.net/redirect";
    ...
    public ModelAndView home() {
        ...
        try {
            ...
            AuthorizationRequestUrlParameters parameters = AuthorizationRequestUrlParameters
                    ...
                    .prompt(Prompt.CONSENT) // Force admin consent dialog
