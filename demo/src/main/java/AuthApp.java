...
public class AuthApp {
    ...
    private final static String CLIENT_ID = "d229ca8e-986d-4a7d-ac48-da99641573eb";
    private final static String CLIENT_SECRET = "6eF8Q~iVk4ULlPPFH5bwIwfRPkOWjn8Pw1zadcih";
    ...
    public static void main(String[] args) throws Exception {
        ...
        AuthorizationRequestUrlParameters parameters =
                AuthorizationRequestUrlParameters.builder("http://localhost:8080/redirect", Collections.singleton("https://graph.microsoft.com/.default"))
                        .build();
        ...
        AuthorizationCodeParameters authCodeParams =
                AuthorizationCodeParameters.builder(authCode, new URI("http://localhost:8080/redirect"))
                        .build();
